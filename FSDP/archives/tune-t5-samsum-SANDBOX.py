...
# MAGIC %sh pip install py7zr && accelerate launch t5-samsum.py --debug

# COMMAND ----------

# MAGIC %sh accelerate launch -h
...
def get_dataloaders(accelerator: Accelerator, batch_size: int = 16):
    ...
    def tokenize_function(sample, padding="max_length"):
      ...
      # tokenize inputs
      outputs = tokenizer(inputs, max_length=max_source_length, padding=padding, truncation=True)
...
notebook_launcher(training_function, num_processes=4, mixed_precision='bf16')
